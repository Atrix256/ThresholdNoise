...
namespace Dither
{
    ...
    PyObject* CreateModule()
    {
        ...
        PyModule_AddIntConstant(module, "NoiseTypes_Bayer", 14);
        PyModule_AddIntConstant(module, "NoiseTypes_Round", 15);
        PyModule_AddIntConstant(module, "NoiseTypes_Floor", 16);
