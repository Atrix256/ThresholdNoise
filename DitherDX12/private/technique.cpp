...
namespace Dither
{
    ...
    bool CreateShared(ID3D12Device* device)
    {
        ...
        // Compute Shader: Dither
        {
            ...
            ranges[12].BaseShaderRegister = 0;
    ...
    void Execute(Context* context, ID3D12Device* device, ID3D12GraphicsCommandList* commandList)
    {
        ...
        ScopedPerfEvent scopedPerf("Dither", commandList, 20);
        ...
        // Compute Shader: Dither
        {
            ...
            D3D12_GPU_DESCRIPTOR_HANDLE descriptorTable = GetDescriptorTable(device, s_srvHeap, descriptors, 13, Context::LogFn);
