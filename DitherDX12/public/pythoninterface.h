...
namespace Dither
{
    inline PyObject* NoiseTypesToString(PyObject* self, PyObject* args)
    {
        ...
        switch((NoiseTypes)value)
        {
            ...
            case NoiseTypes::FAST_Blue_Exp_Separate_Triangle_Plus: return Py_BuildValue("s", "FAST_Blue_Exp_Separate_Triangle_Plus");
            case NoiseTypes::FAST_Blue_Exp_Product_Triangle_Plus: return Py_BuildValue("s", "FAST_Blue_Exp_Product_Triangle_Plus");
            ...
            case NoiseTypes::White_Triangular_Plus: return Py_BuildValue("s", "White_Triangular_Plus");
    ...
    PyObject* CreateModule()
    {
        ...
        PyModule_AddIntConstant(module, "NoiseTypes_FAST_Blue_Exp_Separate_Triangle_Plus", 8);
        PyModule_AddIntConstant(module, "NoiseTypes_FAST_Blue_Exp_Product_Triangle_Plus", 9);
        PyModule_AddIntConstant(module, "NoiseTypes_FAST_Triangle_Blue_Exp_Separate", 10);
        PyModule_AddIntConstant(module, "NoiseTypes_FAST_Triangle_Blue_Exp_Product", 11);
        PyModule_AddIntConstant(module, "NoiseTypes_FAST_Binomial3x3_Exp", 12);
        PyModule_AddIntConstant(module, "NoiseTypes_FAST_Box3x3_Exp", 13);
        PyModule_AddIntConstant(module, "NoiseTypes_Blue_Tellusim_128_128_64", 14);
        PyModule_AddIntConstant(module, "NoiseTypes_Blue_Stable_Fiddusion", 15);
        PyModule_AddIntConstant(module, "NoiseTypes_R2", 16);
        PyModule_AddIntConstant(module, "NoiseTypes_IGN", 17);
        PyModule_AddIntConstant(module, "NoiseTypes_Bayer", 18);
        PyModule_AddIntConstant(module, "NoiseTypes_Bayer_Plus_Half", 19);
        PyModule_AddIntConstant(module, "NoiseTypes_Round", 20);
        PyModule_AddIntConstant(module, "NoiseTypes_Floor", 21);
        PyModule_AddIntConstant(module, "NoiseTypes_White4", 22);
        PyModule_AddIntConstant(module, "NoiseTypes_White4_Plus_Half", 23);
        PyModule_AddIntConstant(module, "NoiseTypes_White_Triangular", 24);
        PyModule_AddIntConstant(module, "NoiseTypes_White_Triangular_Plus", 25);
